...
class DistributedTestFixture : public ::testing::Test {
 protected:
   ...
   */
  distributed::ScenarioDefinition LoadScenario(
   ...
   */
  distributed::ScenarioResult RunScenario(
   ...
   */
  distributed::TestCoordinator* coordinator() {
   ...
   */
  const std::map<std::string, distributed::TestNode*>& GetAllNodes() const {
    return nodes_;
  }
