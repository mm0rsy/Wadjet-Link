...
DistributedTestFixture::DistributedTestFixture()
    : coordinator_address_("127.0.0.1"), coordinator_port_(50051) {}
...
distributed::TestNode* DistributedTestFixture::AddNode(const std::string& node_id,
...
distributed::ScenarioResult DistributedTestFixture::RunScenario(
    const distributed::ScenarioDefinition& scenario, int timeout_ms) {
    if (!coordinator_) {
...
std::vector<distributed::ScenarioResult> DistributedTestFixture::RunScenariosParallel(
...
distributed::TestNode* DistributedTestFixture::GetNode(const std::string& node_id) {
