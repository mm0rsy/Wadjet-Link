...
TEST_F(ResultAggregationIntegrationTest, CollectAndExportJunitResults) {
    ...
    result.global_metadata = {{"test_scenario", "multi_node_latency"},
    ...
    // Node 1: All assertions passed
    {
        ...
        for (int i = 0; i < 5; i++) {
            node1.assertions.push_back(
                AssertionResult{.assertion_id = "ASSERT_NODE1_" + std::to_string(i),
    ...
    // Node 2: Some failures
    {
        ...
        for (int i = 0; i < 3; i++) {
            node2.assertions.push_back(
                AssertionResult{.assertion_id = "ASSERT_NODE2_PASS_" + std::to_string(i),
                                .test_name = "latency_check",
                                .passed = true,
                                .expression = "latency < 100ms",
                                .failure_message = "",
        ...
        node2.assertions.push_back(
            AssertionResult{.assertion_id = "ASSERT_NODE2_FAIL_1",
                            .test_name = "latency_check",
                            .passed = false,
                            .expression = "latency < 100ms",
        ...
        node2.assertions.push_back(
            AssertionResult{.assertion_id = "ASSERT_NODE2_FAIL_2",
    ...
    // Node 3: All passed
    {
        ...
        for (int i = 0; i < 5; i++) {
            node3.assertions.push_back(
                AssertionResult{.assertion_id = "ASSERT_NODE3_" + std::to_string(i),
                                .test_name = "latency_check",
                                .passed = true,
                                .expression = "latency < 100ms",
                                .failure_message = "",
...
TEST_F(ResultAggregationIntegrationTest, GenerateReports) {
    ...
    result.global_metadata = {{"test_id", "TES-001"}, {"test_version", "1.0.0"}};
    ...
    node.assertions.push_back(AssertionResult{.assertion_id = "TEST_001",
    ...
    node.assertions.push_back(
        AssertionResult{.assertion_id = "TEST_002",
    ...
    node.assertions.push_back(
        AssertionResult{.assertion_id = "TEST_003",
...
TEST_F(ResultAggregationIntegrationTest, JsonRoundtrip) {
    ...
    original.global_metadata = {{"test_env", "staging"}, {"test_branch", "develop"}};
    ...
    node.metadata = {{"kernel_version", "5.10.0"}};

    node.assertions.push_back(AssertionResult{.assertion_id = "JSON_TEST_001",
                                              .test_name = "test_1",
                                              .passed = true,
                                              .expression = "expr1",
                                              .failure_message = "",
    ...
    node.assertions.push_back(
        AssertionResult{.assertion_id = "JSON_TEST_002",
                        .test_name = "test_2",
                        .passed = false,
                        .expression = "expr2",
...
TEST_F(ResultAggregationIntegrationTest, FailureCaptureTracking) {
    ...
    node_with_failure.assertions.push_back(
        AssertionResult{.assertion_id = "FAIL_CAPTURE_001",
                        .test_name = "test_1",
                        .passed = true,
                        .expression = "expr1",
                        .failure_message = "",
    ...
    node_with_failure.assertions.push_back(
        AssertionResult{.assertion_id = "FAIL_CAPTURE_002",
                        .test_name = "test_2",
                        .passed = false,
                        .expression = "expr2",
...
TEST_F(ResultAggregationIntegrationTest, LargeScaleAggregation) {
    ...
    result.global_metadata = {{"num_nodes", "10"}, {"num_assertions", "100"}};
